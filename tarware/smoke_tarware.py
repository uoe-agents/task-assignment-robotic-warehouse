# FILE: smoke_tarware.py
"""
Minimal TA-RWARE smoke test to understand the framework flow.

Run:
  python smoke_tarware.py --env-id tarware-tiny-3agvs-2pickers-partialobs-v1 --steps 50 --render
"""
...
def main() -> None:
    ...
    # Multi-agent obs is typically a tuple/list: one per agent
    obs_seq = _as_seq(obs)
